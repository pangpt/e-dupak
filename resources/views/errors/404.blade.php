      ...
      <div class="row justify-content-center">
        <div class="col-12 col-md-5 col-xl-4 my-5">
          ...
          <div class="text-center">
            ...
            <a href="https://github.com/pangpt" class="btn btn-lg btn-outline-dark" target="_blank">
              <span><img src="{{asset('assets/img/github-logo.png')}}" alt="" width="20px"></span> pangpt
            </a>
            <p class="text-muted mb-4">
              atau
            </p>
              <span><img src="{{asset('assets/img/valo.png')}}" alt="" width="30px"></span> Goddamn Steven#4646          
          </div>
